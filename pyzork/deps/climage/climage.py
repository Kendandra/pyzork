...
import pyzork.deps.kdtree as kdtree
import functools
...
palettes = ["default", "xterm", "linuxconsole", "solarized", "rxvt", "tango", "gruvbox", "gruvboxdark"]
...
def _get_system_colors(palette):
    ...
    if palette == "xterm":
        ...
        return [[251, 241, 199, 0], [204, 36, 29, 1], [152, 151, 26, 2], [215, 153, 33, 3], [69, 133, 136, 4], [177, 98, 134, 5], [104, 157, 106, 6], [124, 111, 100, 7], [146, 131, 116, 8], [157, 0, 6, 9], [121, 116, 14, 10], [181, 118, 20, 11], [7, 102, 120, 12], [143, 63, 113, 13], [66, 123, 88, 14], [60, 56, 54, 15]]
    elif palette == "gruvboxdark":
        return [[40, 40, 40, 0], [204, 36, 29, 1], [152, 151, 26, 2], [215, 153, 33, 3], [69, 133, 136, 4], [177, 98, 134, 5], [104, 157, 106, 6], [168, 153, 132, 7], [146, 131, 116, 8], [251, 73, 52, 9], [184, 187, 38, 10], [250, 189, 47, 11], [131, 165, 152, 12], [211, 134, 155, 13], [142, 192, 124, 14], [235, 219, 178, 15]]
